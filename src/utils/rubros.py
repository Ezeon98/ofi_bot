...
CANONICAL_RUBROS: list[str] = [
    ...
    "Constructor de Piscinas", "Electricista domiciliario",
    "Electricista industrial", "Instalación de luminarias",
    "Automatización y domótica", "Instalación de cámaras",
    "Instalación de alarmas", "Porteros eléctricos", "Plomero",
    "Gasista matriculado", "Destapaciones",
    ...
    "Colocación de cuadros y estantes", "Cerrajería", "Cerrajero",
    ...
    "Instalación de impresoras", "Antenista",
    "Instalación de TV satelital", "Fibra óptica", "Redes WiFi",
